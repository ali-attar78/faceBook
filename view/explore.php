...
if ($post["image"]!=""){
    ...
    if($post["gender"]==1){
        echo "view/image/user/user_man.png";
    }
    else{
        echo "view/image/user/user_woman.png";
    }
...
?>"
     class="img-fluid rounded-circle" loading="lazy">
                   ...
                   <div class="col-lg-10 col-md-10 col-sm-10 d-flex ">
                       ...
                       <b>
                           <h4><?php
                               ...
                               echo $post["name"];?></h4>
                           <small><p><?php echo  time2str($post["time"]); ?></p></small>
                       </b>
                       </a>
            ...
            <div class="card-body">
                ...
                <?php
            if (isset($post["media"])):
//                var_dump(mime_content_type($post["media"]));
                if (mime_content_type($post["media"])=='image/jpeg'):?>
                <img src="<?php echo $post["media"];?>" class="img-fluid " loading="lazy">
                <?php elseif (mime_content_type($post["media"])=='video/mp4'): ?>
                    <video style="width: 100%" controls>
                        <source src="<?php echo $post["media"];?>"  type="video/mp4">
                    </video>
                <?php elseif (mime_content_type($post["media"])=='audio/mpeg'): ?>
                    <audio src="<?php echo $post["media"];?>"></audio>
                <?php endif;?>
            <?php endif;?>
            </div>
            ...
            <div class="card-footer text-muted">
               ...
               <button class="btn btn-info">
                   ...
                   <span class="badge text-bg-secondary"><?php echo $post["likes"]["counter"];?></span>
               </button>
                    </div>
                ...
                <div class="row" >
                    <div class="col-lg-12 col-md-12 col-sm-12 " >
                            ...
                            <a class="btn btn-primary mt-2" data-toggle="collapse" href="#collapse<?php echo $post["post_id"];?>" role="button" aria-expanded="false" aria-controls="collapseExample">
                               see the comments
                            </a>
